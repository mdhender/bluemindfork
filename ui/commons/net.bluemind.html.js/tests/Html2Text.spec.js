...
describe('Html2Text', () => {
    ...
    test('Html2Text transformations', () => {
        expect(html2text.fromString(`<a href="https://url.com/resources">Mon beau lien</a>`))
            .toEqual("Mon beau lien [https://url.com/resources]");

        expect(html2text.fromString(`<h1>Mon titre</h1>`)).toEqual("MON TITRE");

        expect(html2text.fromString(`<img src="/resources/img/3">`)).toEqual("");

        expect(html2text.fromString(`<a href="mailto:contact@cmsday.fr" 
