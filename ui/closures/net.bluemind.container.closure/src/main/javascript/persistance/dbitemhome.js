...
goog.provide("net.bluemind.container.persistance.DBItemHome");
...
goog.require("net.bluemind.container.persistance.ResultList");
goog.require("ydn.db");
 ...
 * @constructor
 */
net.bluemind.container.persistance.DBItemHome = function(database) {
 ...
 * @type {number}
 */
net.bluemind.container.persistance.DBItemHome.MAX_LIMIT = 1048576;
/**
 ...
 * @private
 */
net.bluemind.container.persistance.DBItemHome.storage_;

/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.clear = function() {
  return this.storage_.clear();
};

/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.getVersion = function() {
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.setVersion = function(version) {
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.getItem = function(containerId, id) {
...
/** @private */
net.bluemind.container.persistance.DBItemHome.prototype.get_ = function(uids) {
  return this.storage_.values('item', uids);
};

net.bluemind.container.persistance.DBItemHome.prototype.all = function() {
  return this.storage_.values('item');
};

/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.deleteItem = function(containerId, id, opt_sendNotification) {
...
net.bluemind.container.persistance.DBItemHome.prototype.deleteItemWithoutChangeLog = function(containerId, id) {
  return this.getItem(containerId, id).addCallback(function(item) {
    if (item) {
      return this.remove_(item)
    }
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.storeItem = function(containerId, item) {
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.storeItemWithoutChangeLog = function(containerId, item) {
  item['container'] = containerId;
  item['id'] = containerId + '-' + item['uid'];
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.storeItemsWithoutChangeLog = function(containerId, items) {
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.addToChangeLog = function(item) {
  var change = {
    'uid' : item['id'],
    'container' : item['container'],
    'itemId' : item['uid'],
 ...
 * @private
 */
net.bluemind.container.persistance.DBItemHome.prototype.index_ = function(item) {
 ...
 * @private
 */
net.bluemind.container.persistance.DBItemHome.prototype.store_ = function(entries) {
 ...
 * @private
 */
net.bluemind.container.persistance.DBItemHome.prototype.remove_ = function(item) {
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.getIndex = function(containerId, opt_alphabet) {
  var index = [];
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.count = function(containerId) {
  var range = ydn.db.KeyRange.starts([ containerId ]);
  return this.storage_.count('item', 'container, uid', range);
};

/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.getItems = function(containerId, opt_offset) {
  var offset = opt_offset || 0;
  var range = ydn.db.KeyRange.starts([ containerId ]);
  return this.storage_.values('item', 'container, order, uid', range,
      net.bluemind.container.persistance.ResultList.PAGE, offset).addCallback(function(list) {
    var entries = list;
    ...
    // .addCallback(
    // function(total) {
    // var list = new net.bluemind.container.persistance.ResultList( total,
    // entries);
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.getPosition = function(containerId, item) {
 ...
 */
net.bluemind.container.persistance.DBItemHome.prototype.getLocalChangeSet = function(containerId) {
  if (containerId) {
    var range = ydn.db.KeyRange.starts(containerId);
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.syncItems = function(containerId, changed, deleted, version) {
...
net.bluemind.container.persistance.DBItemHome.prototype.clearChangelog = function(containerId, changed, deleted, errors) {
  errors = errors || [];
  deleted = deleted || [];
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.searchItems = function(query, opt_offset, opt_limit) {
  ...
  if (iterators.length == 0) {
    ...
    var result = this.storage_.valuesByIndex(it.getStoreName(), it.getIndexName(), it.getKeyRange(), opt_limit || net.bluemind.container.persistance.DBItemHome.MAX_LIMIT, opt_offset);
  } else {
    var count, out = [];
...
/** @override */
net.bluemind.container.persistance.DBItemHome.prototype.oldsearchItems = function(containerId, query, opt_offset) {
  ...
  return this.storage_.scan(join, iterators).addCallback(function() {
    out = goog.array.slice(out, offset, net.bluemind.container.persistance.ResultList.PAGE);
    return this.get_(out);
  }, this).addCallback(function(entries) {
    return new net.bluemind.container.persistance.ResultList(count, entries);
  }, this);
};
