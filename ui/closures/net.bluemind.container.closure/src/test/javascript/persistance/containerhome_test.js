...
goog.provide('bluemind.container.persistance.ContainerHomeHomeTests');
...
goog.require('bluemind.container.persistance.IContainerHome');
goog.require('bluemind.container.persistance.DBContainerHome');
goog.require('bluemind.container.persistance.WSContainerHome');
...
var withWSHome = function() {
	home = new bluemind.container.persistance.WSContainerHome();
	return;
};
...
var withDBHome = function() {
	home = new bluemind.container.persistance.DBContainerHome();
	return;
};
