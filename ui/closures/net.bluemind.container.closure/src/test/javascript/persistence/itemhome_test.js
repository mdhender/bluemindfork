...
goog.provide('bluemind.container.persistence.ItemHomeTests');

goog.require('bluemind.container.persistence.testdata');
...
goog.require('bluemind.container.persistence.WSItemHome');
goog.require('bluemind.container.persistence.DBItemHome');
goog.require('bluemind.container.persistence.IItemHome');
...
var withDBHome = function() {
	home = new bluemind.container.persistence.DBItemHome();
	return;
};
...
var withWSHome = function() {
	home =  new bluemind.container.persistence.WSItemHome();
	return;
};