...
goog.provide("net.bluemind.authentication.persistance.AuthHome");
 ...
 */
net.bluemind.authentication.persistance.AuthHome = function(ctx) {
 ...
 * @returns {Boolean}
 */
net.bluemind.authentication.persistance.AuthHome.prototype.isLocal = function() {
  return true;
}
 ...
 * @type {ydn.db.Storage}
 */
net.bluemind.authentication.persistance.AuthHome.prototype.storage_;
 ...
 */
net.bluemind.authentication.persistance.AuthHome.prototype.clear = function() {
 ...
 * @return {goog.Promise} promise with the result
 */
net.bluemind.authentication.persistance.AuthHome.prototype.get = function(property, namespace) {
 ...
 * @return {goog.Promise} promise with the result
 */
net.bluemind.authentication.persistance.AuthHome.prototype.set = function(property, value, namespace) {
  if (!namespace && property.indexOf('.') > 0) {
    var parts = property.split('.', 2);
    namespace = parts[0];
    property = parts[1];
