...
goog.provide('net.bluemind.chooser.search.SearchView');
 ...
 */
net.bluemind.chooser.search.SearchView = function(opt_domHelper) {
  ...
  child = new goog.ui.Button(goog.dom.createDom('div', [goog.getCssName('goog-button-icon'), goog.getCssName('fa'),
        goog.getCssName('fa-search')]), goog.ui.style.app.ButtonRenderer.getInstance());

  child.setId('button');
  this.addChild(child, true);
};
goog.inherits(net.bluemind.chooser.search.SearchView, goog.ui.Component);


/** @override */
net.bluemind.chooser.search.SearchView.prototype.createDom = function() {
...
/** @override */
net.bluemind.chooser.search.SearchView.prototype.enterDocument = function() {
...
/** @override */
net.bluemind.chooser.search.SearchView.prototype.setModel = function(model) {
