...
goog.provide("net.bluemind.calendar.list.PendingCountersPresenter");
...
goog.require("net.bluemind.calendar.list.PendingCountersView");
 ...
 */
net.bluemind.calendar.list.PendingCountersPresenter = function(ctx) {

  goog.base(this, ctx);
  this.view_ = new net.bluemind.calendar.list.PendingCountersView(ctx);
...
goog.inherits(net.bluemind.calendar.list.PendingCountersPresenter, net.bluemind.mvp.Presenter);
...
/**
 * @type {net.bluemind.calendar.list.PendingCountersView}
 * @private
 */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.view_;

/**
 * @type {net.bluemind.calendar.vevent.VEventAdaptor}
 * @private
 */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.adaptor_;

/** @override */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.init = function() {
  ...
  this.handler.listenWithScope(this.view_, net.bluemind.calendar.vevent.EventType.SAVE, this.actions_.save, false,
    this.actions_);
  this.handler.listenWithScope(this.view_, net.bluemind.calendar.vevent.EventType.REJECT_COUNTERS, this.actions_.rejectCounters, false,
      this.actions_);
...
/** @override */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.setup = function() {
  var data = {};
  ...
  return this.ctx.service('calendarsMgmt').list('calendar').then(function(applicationCalendars) {
    ...
    var futures = goog.array.map(data.calendars, function(calendar) {
      return this.ctx.service('pendingEventsMgmt').getPendingCounters(calendar.container).then(function(series) {
    ...
    if (data.events.length == 0) {
      ...
      goog.array.sort(data.events, function(e1, e2) {
        return (e1.calendar<e2.calendar?-1:(e1.calendar>e2.calendar?1:0)); 
      });
 ...
 * @private
 */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.calendarToMV_ = function(calendar) {
  var mv = {};
 ...
 * @private
 */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.vseriesToMV_ = function(vseries, calendar) {
  ...
  goog.array.forEach(counters, function(counter) {
    this.adaptVEvent_(counter.counter);
  }, this);
 ...
 * @private
 */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.adaptVEvent_ = function(item) {
...
/** @override */
net.bluemind.calendar.list.PendingCountersPresenter.prototype.exit = function() {
  return goog.Promise.resolve();
};
