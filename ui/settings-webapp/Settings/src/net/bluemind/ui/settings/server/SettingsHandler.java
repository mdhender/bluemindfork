 ...
 * END LICENSE
 */
package net.bluemind.ui.settings.server;
...
public class SettingsHandler extends AbstractIndexHandler {
	...
	protected void loadPageModel(HttpServerRequest request, Map<String, Object> model) {
		...
		model.put("appName", resourceBundle.getString("settings.name"));
	}
