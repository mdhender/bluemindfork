...
public class CalendarMenusContributor implements MenuContributorUnwrapped {
	...
	public MenuContribution contribution() {
		...
		Section calSection = Section.create("/cal/", messages.calendarApp(), 5, null,
		...
		calSection.setRoles(roles);
		JsArray<Contributed<Section>> sections = JsArray.createArray().cast();
		sections.push(Contributed.create(null, calSection));
