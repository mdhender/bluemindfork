...
public class TimeZoneEdit extends CommonForm implements ICommonEditor {

	private ListBox combo;
	private HashMap<String, Integer> items;
	private final String[] TZ = { "Africa/Abidjan", "Africa/Accra", "Africa/Addis_Ababa", "Africa/Algiers",
			...
			"Asia/Bangkok", "Asia/Beirut", "Asia/Bishkek", "Asia/Brunei", "Asia/Choibalsan", "Asia/Chongqing",
			...
			"Asia/Kashgar", "Asia/Kathmandu", "Asia/Kolkata", "Asia/Krasnoyarsk", "Asia/Kuala_Lumpur", "Asia/Kuching",
			...
			"Asia/Pyongyang", "Asia/Qatar", "Asia/Qyzylorda", "Asia/Rangoon", "Asia/Riyadh", "Asia/Sakhalin",
			"Asia/Samarkand", "Asia/Seoul", "Asia/Shanghai", "Asia/Singapore", "Asia/Taipei", "Asia/Tashkent",
			"Asia/Tbilisi", "Asia/Tehran", "Asia/Thimphu", "Asia/Tokyo", "Asia/Ulaanbaatar", "Asia/Urumqi",
			...
			"Europe/Skopje", "Europe/Sofia", "Europe/Stockholm", "Europe/Tallinn", "Europe/Tirane", "Europe/Uzhgorod",
	...
	public TimeZoneEdit() {
		...
		combo = new ListBox();
		combo.getElement().setId("timezone");
		form = combo;
		initValues();
	}
	...
	public String getStringValue() {
		return combo.getValue(combo.getSelectedIndex());
	}

	@Override
	public void setStringValue(String v) {
		if (items.get(v) != null) {
			combo.setSelectedIndex(items.get(v));
		}
	}
