...
import net.bluemind.ui.common.client.forms.finder.UserOrGroupFinder;
 ...
 * 
 */
public class UserOrGroupEntityEdit extends EntityEdit<DirEntry, DirEntryQuery> {

	@UiConstructor
	public UserOrGroupEntityEdit(boolean multival) {
		super(new UserOrGroupFinder(), multival, false, null);
	}

	public void setDomain(ItemValue<Domain> domain) {
		((UserOrGroupFinder) getFinder()).setDomain(domain);

	}

	public void setDomain(String domainUid) {
		((UserOrGroupFinder) getFinder()).setDomain(domainUid);
