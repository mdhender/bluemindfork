...
public class WebexPlugin implements EntryPoint {
	...
	private void init() {
		...
		ScreenElementContributor.exportAsfunction("NetBluemindUiAdminconsoleVideoConferencingWebexScreenContributor",
				ScreenElementContributor.create(new WebexScreenContributor()));
	}
}
