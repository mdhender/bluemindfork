...
public class WebexEditor extends CompositeGwtWidgetElement {
	...
	private static WebexEditorUiBinder uiBinder = GWT.create(WebexEditorUiBinder.class);

	interface WebexEditorUiBinder extends UiBinder<HTMLPanel, WebexEditor> {
	}
	...
	void deleteClick(ClickEvent e) {
		if (Window.confirm(WebexConstants.INST.deleteBtnConfirm())) {
			removeResource();
		}
	}
