...
public class LdapExportPlugin implements EntryPoint {
	public static void init() {
		...
		ScreenElementContributor.exportAsfunction("NetBluemindUiAdminconsoleDomainLdapExportScreenContributor",
				ScreenElementContributor.create(new ServiceTabContributor()));
	}
