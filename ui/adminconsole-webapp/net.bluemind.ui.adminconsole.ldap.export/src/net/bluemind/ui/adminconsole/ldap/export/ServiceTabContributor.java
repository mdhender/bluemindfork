...
public class ServiceTabContributor implements ScreenElementContributorUnwrapper {
	...
	public JsArray<ScreenElementContribution> contribution() {
		ScreenElementContribution ldapExportElement = ScreenElementContribution.create("editDomainBmServices",
				"childrens", ScreenElement.create(null, LdapExportServerEditor.TYPE));

		JsArray<ScreenElementContribution> contribs = JsArray.createArray().cast();
		contribs.push(ldapExportElement);
		return contribs;
	}
}
