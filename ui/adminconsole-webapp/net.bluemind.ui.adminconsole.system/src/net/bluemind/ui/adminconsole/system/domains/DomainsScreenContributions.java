...
public class DomainsScreenContributions {
	...
	public static JsArray<ScreenElementContribution> contribution() {
		...
		contribs.push(ScreenElementContribution.create(null, null,
				ScreenElement.create("domainsManager", DomainsScreen.TYPE)));
		contribs.push(ScreenElementContribution.create(null, null, QCreateDomainScreen.screenModel()));
		contribs.push(ScreenElementContribution.create(null, null, EditDomainScreen.screenModel()));
		return contribs;
	}
