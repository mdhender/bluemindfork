...
public class LdapPlugin implements EntryPoint {
	public static void init() {
		BasePlugin.install();
		EditDomainLdapEditor.registerType();
		LdapModelHandler.registerType();

		ScreenElementContributor.exportAsfunction("NetBluemindUiAdminconsoleDomainLdapScreenContributor",
