...
import net.bluemind.ui.adminconsole.videoconferencing.zoom.l10n.ZoomConstants;
...
public class ZoomEditor extends CompositeGwtWidgetElement {

	static final String TYPE = "bm.ac.ZoomEditor";

	private static final String PROVIDER_NAME = "Zoom";
	private static final String PROVIDER_TYPE = "videoconferencing-zoom";
	...
	private static ZoomEditorUiBinder uiBinder = GWT.create(ZoomEditorUiBinder.class);

	interface ZoomEditorUiBinder extends UiBinder<HTMLPanel, ZoomEditor> {
	}
	...
	void deleteClick(ClickEvent e) {
		if (Window.confirm(ZoomConstants.INST.deleteBtnConfirm())) {
			removeResource();
		}
	}
