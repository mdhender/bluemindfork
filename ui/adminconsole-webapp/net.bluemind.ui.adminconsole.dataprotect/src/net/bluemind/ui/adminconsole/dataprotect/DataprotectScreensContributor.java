...
public class DataprotectScreensContributor implements ScreenElementContributorUnwrapper {
	...
	public JsArray<ScreenElementContribution> contribution() {
		...
		contribs.push(
				ScreenElementContribution.create(null, null, ScreenElement.create("dpNavigator", DPNavigator.TYPE)));
		contribs.push(ScreenElementContribution.create(null, null,
				ScreenElement.create("dpGenBrowser", GenerationBrowser.TYPE)));
		contribs.push(ScreenElementContribution.create(null, null, ScreenElement.create("dpPolicy", DPPolicy.TYPE)));
