...
public class MonitoringPlugin implements EntryPoint {
	...
	public static void init() {
		...
		ScreenElementContributor.exportAsfunction("NetBluemindUiAdminconsoleMonitoringScreensContributor",
				ScreenElementContributor.create(new MonitoringScreensContributor()));
