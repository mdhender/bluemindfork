...
public class RowSelectionEventManager<T> extends DefaultSelectionEventManager<T> {
	...
	public static <T> RowSelectionEventManager<T> createRowManager(IEditHandler<T> handler) {
		return new RowSelectionEventManager<T>(new RowEventTranslator<T>(handler));
	}
}
