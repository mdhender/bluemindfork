...
public class DEPager extends SimplePager {
	...
	private static final DEPager.Resources pagerResources = GWT.create(DEPager.Resources.class);

	public static interface DEPagerConstant extends Constants {
		String pagerOf();

	}

	private static final DEPagerConstant constants = GWT.create(DEPagerConstant.class);

	public DEPager() {
		this(TextLocation.RIGHT, pagerResources, false, 0, true);
	}

	public DEPager(TextLocation location, Resources resources, boolean showFastForwardButton, int fastForwardRows,
