...
public class UserCalendarsEditor extends CompositeGwtWidgetElement {

	public static final String TYPE = "bm.ac.UserCalendarsEditor";
	private JavaScriptObject model;
	private CalendarManagement calendarMgmt;

	public UserCalendarsEditor() {
	...
	public void loadModel(JavaScriptObject model) {
		...
		this.model = model;
		JsMapStringString map = model.cast();
		String domainUid = map.get("domainUid");
		String owner = map.get("userId");

		calendarMgmt.setDomainAndOwner(domainUid, owner);
	...
	public static void registerType() {
		GwtWidgetElement.register(TYPE, new IGwtDelegateFactory<IGwtWidgetElement, WidgetElement>() {
			...
			public IGwtWidgetElement create(WidgetElement e) {
				return new UserCalendarsEditor();
			}
		});
