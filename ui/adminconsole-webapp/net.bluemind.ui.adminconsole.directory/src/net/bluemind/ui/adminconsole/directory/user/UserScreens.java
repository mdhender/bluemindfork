...
public class UserScreens {
	...
	public static JsArray<ScreenElementContribution> getContributions() {
		...
		contribs.push(ScreenElementContribution.create(null, null, QCreateUserScreen.screenModel()));
		contribs.push(ScreenElementContribution.create(null, null, EditUserScreen.screenModel()));
		return contribs;
