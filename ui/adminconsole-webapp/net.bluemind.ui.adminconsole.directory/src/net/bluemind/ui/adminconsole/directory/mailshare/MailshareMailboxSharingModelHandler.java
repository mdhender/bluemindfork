...
public class MailshareMailboxSharingModelHandler extends BaseSharingModelHandler {

	public static final String TYPE = "bm.ac.MailshareMailboxSharingModelHandler";
	static final String MODEL_ID = "mailbox-sharing";

	public MailshareMailboxSharingModelHandler() {
		super(MODEL_ID);
	}
		...
		GwtModelHandler.register(TYPE,
				new IGwtDelegateFactory<IGwtModelHandler, net.bluemind.gwtconsoleapp.base.editor.ModelHandler>() {
					...
					public IGwtModelHandler create(net.bluemind.gwtconsoleapp.base.editor.ModelHandler model) {
						return new MailshareMailboxSharingModelHandler();
					}
				});
	}
