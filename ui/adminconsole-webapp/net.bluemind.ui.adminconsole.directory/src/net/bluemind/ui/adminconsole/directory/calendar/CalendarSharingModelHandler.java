...
public class CalendarSharingModelHandler extends BaseSharingModelHandler {

	public static final String TYPE = "bm.ac.CalendarSharingModelHandler";

	private CalendarSharingModelHandler() {
	...
	public static void registerType() {
		GwtModelHandler.register(TYPE, new IGwtDelegateFactory<IGwtModelHandler, ModelHandler>() {
			...
			public IGwtModelHandler create(ModelHandler e) {
				return new CalendarSharingModelHandler();
			}
		});
	}
}
