...
public interface ResourceTypeMenusConstants extends ConstantsWithLookup {
	...
	public static final ResourceTypeMenusConstants INST = GWT.create(ResourceTypeMenusConstants.class);

	public String qcResourceType();

	public String editResourceType();

	public String browseResourceType();
