...
public class ResourceMenus {
	...
	public static MenuContribution getContribution() {
		...
		ResourceMenusConstants v = GWT.create(ResourceMenusConstants.class);
		...
		screens.push(Contributed.create("directories",
				Screen.createDirEditor("editResource", v.editResource(), null, false)));

		screens.push(Contributed.create("dir1",
				Screen.create("qcResource", v.qcResource(), BasicRoles.ROLE_MANAGE_RESOURCE, false)
						.withOURoles(BasicRoles.ROLE_MANAGE_RESOURCE)));
