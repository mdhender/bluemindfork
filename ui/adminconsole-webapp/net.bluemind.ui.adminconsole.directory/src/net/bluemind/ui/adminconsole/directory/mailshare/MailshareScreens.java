...
public class MailshareScreens {
	...
	public static JsArray<ScreenElementContribution> getContributions() {
		...
		contribs.push(ScreenElementContribution.create(null, null, QCreateMailshareScreen.screenModel()));
		contribs.push(ScreenElementContribution.create(null, null, EditMailshareScreen.screenModel()));
		return contribs;
	}
}
