...
public class GroupScreens {
	...
	public static JsArray<ScreenElementContribution> getContributions() {
		...
		contribs.push(ScreenElementContribution.create(null, null, QCreateGroupScreen.screenModel()));
		contribs.push(ScreenElementContribution.create(null, null, EditGroupScreen.screenModel()));
		return contribs;
