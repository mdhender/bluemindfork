...
public class SecurityPlugin {
	...
	public static void init() {
		...
		MenuContributor.exportAsfunction("NetBluemindUiAdminconsoleSecurityContributor",
				MenuContributor.create(new SecurityMenusContributor()));

		ScreenElementContributor.exportAsfunction("NetBluemindUiAdminconsoleScreensSecurityContributor",
				ScreenElementContributor.create(new SecurityScreensContributor()));
	}
}
