<template>
    <bm-row
        class="mail-message-list-item-shadow-multiple py-2 no-gutters align-items-center"
...
export default {
    name: "MailMessageListItemShadowMultiple",
    components: {
        BmRow,
        BmCol,
        BmIcon
...
.mail-message-list-item-shadow-multiple::before,
.mail-message-list-item-shadow-multiple::after {
    content: "";
    position: absolute;
    height: 100%;
    width: 100%;
...
.mail-message-list-item-shadow-multiple.lot-of::before {
    left: -8px;
    top: -8px;
    z-index: -2;
}
