...
export function areAllSelectedMessagesUnflagged(state, getters, rootState, rootGetters) {
    /*
     * BEST EFFORT
    ...
    return state.selectedMessageKeys.every(selectedMessageKey => {
        ...
        return !rootGetters["mail/isLoaded"](selectedMessageKey) || !selectedItem.flags.includes(Flag.FLAGGED);
    });
}
