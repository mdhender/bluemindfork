...
export const FOLDER_BY_MAILBOX = "FOLDER_BY_MAILBOX";
const folderByMailbox = state => mailboxKey => Object.values(state).filter(folder => folder.mailbox === mailboxKey);
...
export default {
    ...
    [FOLDER_BY_MAILBOX]: folderByMailbox,
