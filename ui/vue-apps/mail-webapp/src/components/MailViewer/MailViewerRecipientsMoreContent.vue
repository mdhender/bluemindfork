<template>
    <div class="mail-viewer-recipients-more-content" tabindex="0" @keyup.esc="$emit('close')">
        ...
        <div class="overflow-auto pb-2">
            <div class="d-flex">
                <div class="custom-col-left text-secondary text-right pr-2">{{ $t("common.from") }}</div>
            ...
            <div class="d-flex">
                <div class="custom-col-left text-secondary text-right pr-2">{{ $t("common.date") }}</div>
                <div class="fcustom-col-right font-weight-bold">{{ new Date(message.date).toLocaleString() }}</div>
            </div>
            <div class="d-flex">
                <div class="custom-col-left text-secondary text-right pr-2">{{ $t("common.subject") }}</div>
