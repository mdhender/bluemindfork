...
public abstract class AbstractWrapperHandler extends AbstractIndexHandler {

	@Override
	protected String getTemplateName() {
		return "WrappedWebApp.ftl";
	}

	protected abstract String getAppNameI18NKey();
	...
	protected void loadPageModel(HttpServerRequest request, Map<String, Object> model) {
		...
		model.put("appName", resourceBundle.getString(getAppNameI18NKey()));
	}
