...
class rcube_mime
{
    ...
    private static function structure_part($part, $count=0, $parent='')
    {
        ...
        $struct->ctype_primary = strtolower($part->ctype_primary);
        $struct->ctype_secondary = strtolower($part->ctype_secondary);
        ...
        $struct->body = $struct->ctype_primary == 'text' || !$part->ctype_parameters['charset'] ? rcube_charset::convert($part->body, $part_charset) : $part->body;
