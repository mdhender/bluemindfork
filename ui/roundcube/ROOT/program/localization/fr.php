...
$labels['compose']='Nouveau message';
...
$labels['deletemessage']='Supprimer le message définitivement';
...
$labels['sendmessage']='Envoyer le message';
...
$labels['addcc']='Cc';
$labels['addbcc']='Cci';
$labels['addreplyto']='Répondre à';
$labels['addfollowupto']='Faire suivre à';
...
$labels['importtext'] = 'Vous pouvez envoyer des contacts depuis un carnet d\'adresse existant. Nous supportons actuellement l\'importation d\'adresses au format <a href="http://en.wikipedia.org/wiki/VCard">vCard</a>.';
$labels['done']='Terminé';
// settings
...
$labels['webmail']='Messagerie';
$labels['calendar']='Agenda';
$labels['administration']='Administration';
$labels['bmsettings']='Paramètres';
$labels['online']='En ligne';
$labels['onlinetip']='Vous êtes en ligne';
$labels['nounreadmail']='Pas de courrier non lu';
$labels['oneunreadmail']='Un courrier non lu';
$labels['unreadmails']='courriers non lus';
$labels['outbox']='Boîte d\'envoi';
$labels['sharedfolders']='Dossiers partagés';
$labels['otherusers']='Autres utilisateurs';
