...
$labels['forwardmode']='Re-envio';
$labels['inline']='En línea';
$labels['asattachment']='adjunto';
...
$labels['webmail']='Correo';
$labels['calendar']='Calendario';
$labels['administration']='Administración';
$labels['bmsettings']='Configuración';
$labels['online']='Conectado';
$labels['onlinetip']='Estás conectado';
$labels['nounreadmail']='No hay correo sin leer';
$labels['oneunreadmail']='Un mensaje sin leer';
$labels['unreadmails']='correo sin leer';
$labels['outbox']='Bandeja de salida';
$labels['sharedfolders']='Carpetas compartidas';
$labels['otherusers']='Otros usuarios';
