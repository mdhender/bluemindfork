...
$labels['webmail']='Poczta';
$labels['calendar']='Kalendarz';
$labels['administration']='Administracja';
$labels['bmsettings']='Ustawienia';
$labels['online']='Online';
$labels['onlinetip']='Jesteś w trybie online';
$labels['nounreadmail']='Brak nieprzeczytanej poczty';
$labels['oneunreadmail']='Jedna nieprzeczytana wiadomość';
$labels['unreadmails']='nieprzeczytane wiadomości';
$labels['outbox']='Wychodzące';
$labels['sharedfolders']='Udostępnione katalogi';
$labels['otherusers']='Inni użytkownicy';
