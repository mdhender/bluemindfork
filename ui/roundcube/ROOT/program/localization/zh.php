...
$labels['isdraft']='草稿';
$labels['andnmore']='更多 $nr ...';
$labels['htmltoggle']='超文本';
...
$labels['importtext']='你可以从已有的地址簿导入联系人。<br/>目前支持从  <a href="http://en.wikipedia.org/wiki/VCard">vCard</a> 数据格式导入地址簿。';
$labels['done']='完成';
// settings
...
$labels['listnamedisplay']='联系人列表作为';
...
$labels['mailtoprotohandler']='注册mailto协议句柄到:links';
$labels['forwardmode']='消息转发中';
$labels['inline']='在线';
...
$labels['bmsettings']='设置';
$labels['online']='在线';
$labels['onlinetip']='在线';
$labels['nounreadmail']='没有未读邮件';
$labels['oneunreadmail']='一封未读邮件';
$labels['unreadmails']='未读邮件';
$labels['outbox']='发件箱';
$labels['sharedfolders']='共享文件夹';
$labels['otherusers']='其他用户';
