...
$rcmail_config['mailshares_mbox'] = 'Dossiers partag&AOk-s';
$rcmail_config['users_mbox'] = 'Autres utilisateurs';
...
$rcmail_config['log_dir'] = '/var/log/bm-webmail/';
...
$rcmail_config['memcache_hosts'] = array('127.0.0.1:11211'); // e.g. array( 'localhost:11211', '192.168.1.12:11211', 'unix:///var/tmp/memcached.sock' );
...
$rcmail_config['product_name'] = 'Webmail - Blue Mind';
...
$rcmail_config['dont_override'] = array('use_subscriptions', 'skin', 'language', 'default_charset', 'read_when_deleted', 'flag_for_deletion', 'skip_deleted', 'logout_expunge', 'mime_param_folding', 'force_7bit', 'timezone', 'time_format', 'date_format', 'keep_alive');
...
$rcmail_config['list_cols'] = array('chbox', 'status', 'flag', 'fromto', 'subject', 'attachment', 'date', 'size');
...
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['default_imap_folders'] = array('INBOX', 'Drafts', 'Sent', 'Outbox', 'Junk', 'Trash');
...
// end of config file
if (is_readable('/etc/bm-webmail/custom.inc.php')) {
  include_once('/etc/bm-webmail/custom.inc.php');
}
