...
public class UserBooksSubscriptionEditor extends BaseSubscriptionsEditor {
	...
	public static void registerType() {
		GwtWidgetElement.register(TYPE, new IGwtDelegateFactory<IGwtWidgetElement, WidgetElement>() {
			...
			public IGwtWidgetElement create(WidgetElement e) {
				return new UserBooksSubscriptionEditor();
			}
		});
	...
	protected boolean canUnsubscribe(ContainerSubscriptionDescriptor f) {
		return super.canUnsubscribe(f) //
				&& !f.containerUid.equals("book:CollectedContacts_" + userId)//
				&& !f.containerUid.equals("book:Contacts_" + userId);
	}

	@Override
	protected String getAddLabel() {
		return BookConstants.INST.addAddressbook();
	}
}
