...
public class UserCalendarsSharingModelHandler extends BaseOwnerSharingsModelHandler {

	public static final String TYPE = "bm.user.UserCalendarsSharingModelHandler";

	public UserCalendarsSharingModelHandler() {
		super("calendar", "calendars-sharing");
	}
		...
		GwtModelHandler.register(TYPE,
				new IGwtDelegateFactory<IGwtModelHandler, net.bluemind.gwtconsoleapp.base.editor.ModelHandler>() {
					...
					public IGwtModelHandler create(net.bluemind.gwtconsoleapp.base.editor.ModelHandler model) {
						return new UserCalendarsSharingModelHandler();
					}
				});
	}
}
