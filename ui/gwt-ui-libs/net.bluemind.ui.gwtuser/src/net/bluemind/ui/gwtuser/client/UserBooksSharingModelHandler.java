...
public class UserBooksSharingModelHandler extends BaseOwnerSharingsModelHandler {

	public static final String TYPE = "bm.user.UserBooksSharingModelHandler";

	public UserBooksSharingModelHandler() {
		...
		GwtModelHandler.register(TYPE,
				new IGwtDelegateFactory<IGwtModelHandler, net.bluemind.gwtconsoleapp.base.editor.ModelHandler>() {
					...
					public IGwtModelHandler create(net.bluemind.gwtconsoleapp.base.editor.ModelHandler model) {
						return new UserBooksSharingModelHandler();
					}
				});
	}
}
