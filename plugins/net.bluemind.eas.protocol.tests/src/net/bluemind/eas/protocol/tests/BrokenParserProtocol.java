...
import net.bluemind.eas.protocol.tests.BrokenParserProtocol.BrokenReq;
import net.bluemind.eas.protocol.tests.BrokenParserProtocol.BrokenResp;

public class BrokenParserProtocol implements IEasProtocol<BrokenReq, BrokenResp> {
