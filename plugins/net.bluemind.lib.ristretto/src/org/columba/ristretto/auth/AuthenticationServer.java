...
public interface AuthenticationServer {
	...
	/**
	 * Gets the hostname of the server. This is for example sasl.example.com.
	 * 
	...
	/**
	 * Gets the service that is provided by the server. An example is "pop3" or
	 * "imap".
	 * 
	 ...
	 * 
	 * @param call
	 *            the call of the client to the server
	 * @throws IOException
	 */
