...
/**
 * Implementation of the Digest-MD5 SASL AuthenticationMechanism. The
 * implementation is based on the jsse.jar delivered starting with JRE 1.4.2.
 * 
 * @author Timo Stich <tstich@users.sourceforge.net>
 */
public class DigestMD5Mechanism implements AuthenticationMechanism, CallbackHandler {
