...
public class AddressbookServerMember extends Property implements Escapable {
	...
	public AddressbookServerMember(String value) {
		super("ADDRESSBOOKSERVER-MEMBER");
		this.value = value;
	}
	...
	private static class Factory implements PropertyFactory<Property> {
		 ...
		 * {@inheritDoc}
		 */
		public AddressbookServerMember createProperty(final List<Parameter> params, final String value) {
			return new AddressbookServerMember(params, value);
		}
