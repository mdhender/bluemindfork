...
import net.bluemind.eas.command.mail.smartforward.SmartForwardEndpoint;
...
public class SmartForwardEndpointTests extends AbstractEndpointTest {

	public void testSmartForward() throws Exception {
		Integer inbox = fetchInboxId();
		Integer uid = sendMail();

		Document document = DOMUtils.createDoc("ComposeMail", "SmartForward");
	...
	public WbxmlHandlerBase createEndpoint() {
		return new SmartForwardEndpoint();
	}
