 ...
 * 
 */
public class ProvisionEndpoint extends WbxmlHandlerBase implements IEasRequestEndpoint {
	...
	public ProvisionEndpoint() {
		protocol = new ProvisionProtocol();
	}

	@Override
	public void handle(AuthorizedDeviceQuery dq, Document doc) {
		if (logger.isDebugEnabled()) {
			logger.debug("Provision with protocol...");
		}
	...
	public Collection<String> supportedCommands() {
		return ImmutableList.of("Provision");
	}
