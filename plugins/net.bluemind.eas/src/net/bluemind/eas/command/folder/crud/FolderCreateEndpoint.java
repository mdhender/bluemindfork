...
public class FolderCreateEndpoint extends WbxmlHandlerBase implements IEasRequestEndpoint {
	...
	private static final Logger logger = LoggerFactory.getLogger(FolderCreateEndpoint.class);

	private FolderCreateProtocol protocol;

	public FolderCreateEndpoint() {
		protocol = new FolderCreateProtocol();
	}
	...
	public Collection<String> supportedCommands() {
		return ImmutableList.of("FolderCreate");
	}
