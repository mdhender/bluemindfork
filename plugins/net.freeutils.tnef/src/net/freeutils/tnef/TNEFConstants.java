...
public class TNEFConstants {
	 ...
	 */
	public static final long TNEF_SIGNATURE = 0x223e9f78, TNEF_VERSION = 0x00010000;

	/**
	 * TNEF message flag constant.
	 */
	public static final byte fmsNull = 0x00, fmsModified = 0x01, fmsLocal = 0x02, fmsSubmitted = 0x04, fmsRead = 0x20,
			fmsHasAttach = (byte) 0x80;

	/**
	 * TNEF message priority constant.
	 */
	public static final int prioLow = 3, prioNorm = 2, prioHigh = 1;
