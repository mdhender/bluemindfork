...
public class Attachment {
	 ...
	 * @return the requested Attachment attribute, or null if no such attribute
	 *         exists
	 */
	 ...
	 *
	 * @param attr
	 *            the Attachment attribute to add
	 */
	 ...
	 *
	 * @param filename
	 *            the fully qualified filename to which the attachment content
	 *            should be written
	 * @throws IOException
	 *             if an I/O error occurs
	 */
	 ...
	 *
	 * @param out
	 *            the OutputStream to which the attachment content should be
	 *            written
	 * @throws IOException
	 *             if an I/O error occurs
	 */
