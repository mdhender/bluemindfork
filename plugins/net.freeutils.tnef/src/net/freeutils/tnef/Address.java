...
/**
 * The <code>Address</code> class encapsulates an address used in some TNEF
 * message attributes.
 *
...
public class Address {
	...
	public String toString() {
		return new StringBuffer().append('"').append(getDisplayName()).append("\" [").append(getType()).append(':')
				.append(getAddress()).append(']').toString();
	}
