...
public class ContactHandler {
	...
	static ContactField[] contactFields = { new ContactField("BEGIN", "VCARD"), // must
			...
			new ContactField("FN",
					new Integer[] { new Integer(MAPIProp.PR_GIVEN_NAME), new Integer(MAPIProp.PR_MIDDLE_NAME),
							new Integer(MAPIProp.PR_SURNAME), new Integer(MAPIProp.PR_GENERATION) },
					ContactField.MUST, "%s %s %s %s"),
			new ContactField("N",
					new Integer[] { new Integer(MAPIProp.PR_SURNAME), new Integer(MAPIProp.PR_GIVEN_NAME),
							new Integer(MAPIProp.PR_MIDDLE_NAME), new Integer(MAPIProp.PR_DISPLAY_NAME_PREFIX),
							new Integer(MAPIProp.PR_GENERATION) },
					ContactField.MUST, "%s;%s;%s;%s;%s"),
			new ContactField("NICKNAME", new Integer(MAPIProp.PR_NICKNAME)),
			// "PHOTO"
			new ContactField("BDAY", new Integer(MAPIProp.PR_BIRTHDAY), ContactField.NONE, "yyyy-MM-dd'T'HH:mm:ss'Z'"),
			new ContactField("ADR;TYPE=WORK",
					new Integer[] { null, new Integer(MAPIProp.PR_OFFICE_LOCATION),
							new Integer(MAPIProp.PR_STREET_ADDRESS), new Integer(MAPIProp.PR_LOCALITY),
							new Integer(MAPIProp.PR_STATE_OR_PROVINCE), new Integer(MAPIProp.PR_POSTAL_CODE),
							new Integer(MAPIProp.PR_COUNTRY) },
					ContactField.NONE, "%s;%s;%s;%s;%s;%s;%s"),
			new ContactField("LABEL;TYPE=WORK",
					new Integer[] { new Integer(MAPIProp.PR_OFFICE_LOCATION), new Integer(MAPIProp.PR_STREET_ADDRESS),
							new Integer(MAPIProp.PR_LOCALITY), new Integer(MAPIProp.PR_STATE_OR_PROVINCE),
							new Integer(MAPIProp.PR_POSTAL_CODE), new Integer(MAPIProp.PR_COUNTRY) },
					ContactField.NONE, "%s\r\n%s\r\n%s, %s %s\r\n%s"),
			new ContactField("ADR;TYPE=HOME", new Integer[] { null, null, new Integer(MAPIProp.PR_HOME_ADDRESS_STREET),
					new Integer(MAPIProp.PR_HOME_ADDRESS_CITY), new Integer(MAPIProp.PR_HOME_ADDRESS_STATE_OR_PROVINCE),
					new Integer(MAPIProp.PR_HOME_ADDRESS_POSTAL_CODE), new Integer(MAPIProp.PR_HOME_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s;%s;%s;%s;%s;%s;%s"),
			new ContactField("LABEL;TYPE=HOME", new Integer[] { new Integer(MAPIProp.PR_HOME_ADDRESS_STREET),
					new Integer(MAPIProp.PR_HOME_ADDRESS_CITY), new Integer(MAPIProp.PR_HOME_ADDRESS_STATE_OR_PROVINCE),
					new Integer(MAPIProp.PR_HOME_ADDRESS_POSTAL_CODE), new Integer(MAPIProp.PR_HOME_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s\r\n%s, %s %s\r\n%s"),
			new ContactField("ADR;TYPE=POSTAL",
					new Integer[] { null, null, new Integer(MAPIProp.PR_OTHER_ADDRESS_STREET),
			...
			new ContactField("LABEL;TYPE=POSTAL",
					new Integer[] { new Integer(MAPIProp.PR_OTHER_ADDRESS_STREET),
							new Integer(MAPIProp.PR_OTHER_ADDRESS_CITY),
							new Integer(MAPIProp.PR_OTHER_ADDRESS_STATE_OR_PROVINCE),
							new Integer(MAPIProp.PR_OTHER_ADDRESS_POSTAL_CODE),
							new Integer(MAPIProp.PR_OTHER_ADDRESS_COUNTRY) },
			...
			new ContactField("ORG",
					new Integer[] { new Integer(MAPIProp.PR_COMPANY_NAME), new Integer(MAPIProp.PR_DEPARTMENT_NAME) },
