...
/**
 * The <code>ContactHandler</code> class converts contacts from a TNEF message
...
public class ContactHandler {
	...
	static ContactField[] contactFields = { new ContactField("BEGIN", "VCARD"), // must
																				// be
																				// first
			new ContactField("VERSION", "3.0"),
			new ContactField("FN",
					new Integer[] { Integer.valueOf(MAPIProp.PR_GIVEN_NAME), Integer.valueOf(MAPIProp.PR_MIDDLE_NAME),
							Integer.valueOf(MAPIProp.PR_SURNAME), Integer.valueOf(MAPIProp.PR_GENERATION) },
					ContactField.MUST, "%s %s %s %s"),
			new ContactField("N",
					new Integer[] { Integer.valueOf(MAPIProp.PR_SURNAME), Integer.valueOf(MAPIProp.PR_GIVEN_NAME),
							Integer.valueOf(MAPIProp.PR_MIDDLE_NAME), Integer.valueOf(MAPIProp.PR_DISPLAY_NAME_PREFIX),
							Integer.valueOf(MAPIProp.PR_GENERATION) },
					ContactField.MUST, "%s;%s;%s;%s;%s"),
			new ContactField("NICKNAME", Integer.valueOf(MAPIProp.PR_NICKNAME)),
			// "PHOTO"
			new ContactField("BDAY", Integer.valueOf(MAPIProp.PR_BIRTHDAY), ContactField.NONE,
					"yyyy-MM-dd'T'HH:mm:ss'Z'"),
			new ContactField("ADR;TYPE=WORK",
					new Integer[] { null, Integer.valueOf(MAPIProp.PR_OFFICE_LOCATION),
							Integer.valueOf(MAPIProp.PR_STREET_ADDRESS), Integer.valueOf(MAPIProp.PR_LOCALITY),
							Integer.valueOf(MAPIProp.PR_STATE_OR_PROVINCE), Integer.valueOf(MAPIProp.PR_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_COUNTRY) },
					ContactField.NONE, "%s;%s;%s;%s;%s;%s;%s"),
			new ContactField("LABEL;TYPE=WORK",
					new Integer[] { Integer.valueOf(MAPIProp.PR_OFFICE_LOCATION),
							Integer.valueOf(MAPIProp.PR_STREET_ADDRESS), Integer.valueOf(MAPIProp.PR_LOCALITY),
							Integer.valueOf(MAPIProp.PR_STATE_OR_PROVINCE), Integer.valueOf(MAPIProp.PR_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_COUNTRY) },
					ContactField.NONE, "%s\r\n%s\r\n%s, %s %s\r\n%s"),
			new ContactField("ADR;TYPE=HOME",
					new Integer[] { null, null, Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_STREET),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_CITY),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_STATE_OR_PROVINCE),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s;%s;%s;%s;%s;%s;%s"),
			new ContactField("LABEL;TYPE=HOME",
					new Integer[] { Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_STREET),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_CITY),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_STATE_OR_PROVINCE),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_HOME_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s\r\n%s, %s %s\r\n%s"),
			new ContactField("ADR;TYPE=POSTAL",
					new Integer[] { null, null, Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_STREET),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_CITY),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_STATE_OR_PROVINCE),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s;%s;%s;%s;%s;%s;%s"),
			new ContactField("LABEL;TYPE=POSTAL",
					new Integer[] { Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_STREET),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_CITY),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_STATE_OR_PROVINCE),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_POSTAL_CODE),
							Integer.valueOf(MAPIProp.PR_OTHER_ADDRESS_COUNTRY) },
					ContactField.NONE, "%s\r\n%s, %s %s\r\n%s"),
			new ContactField("TEL;TYPE=HOME,VOICE", Integer.valueOf(MAPIProp.PR_HOME_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=HOME", Integer.valueOf(MAPIProp.PR_HOME2_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=HOME,FAX", Integer.valueOf(MAPIProp.PR_HOME_FAX_NUMBER)),
			new ContactField("TEL;TYPE=WORK,VOICE", Integer.valueOf(MAPIProp.PR_BUSINESS_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=WORK,VOICE", Integer.valueOf(MAPIProp.PR_BUSINESS2_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=WORK,FAX", Integer.valueOf(MAPIProp.PR_BUSINESS_FAX_NUMBER)),
			new ContactField("TEL;TYPE=CELL,VOICE", Integer.valueOf(MAPIProp.PR_MOBILE_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=CAR,VOICE", Integer.valueOf(MAPIProp.PR_CAR_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=PREF,VOICE", Integer.valueOf(MAPIProp.PR_CALLBACK_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=VOICE", Integer.valueOf(MAPIProp.PR_OTHER_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=PAGER,VOICE", Integer.valueOf(MAPIProp.PR_PAGER_TELEPHONE_NUMBER)),
			new ContactField("TEL;TYPE=ISDN", Integer.valueOf(MAPIProp.PR_ISDN_NUMBER)),
			new ContactField("TEL;TYPE=PREF", Integer.valueOf(MAPIProp.PR_PRIMARY_TELEPHONE_NUMBER)),
			new ContactField("EMAIL;TYPE=PREF,INTERNET", new MAPIPropName(MAPIProp.GUID_CDOPROPSETID3, 0x8083)), // CdoContact_EmailEmailAddress
			new ContactField("EMAIL;TYPE=TLX", Integer.valueOf(MAPIProp.PR_TELEX_NUMBER)),
			// "MAILER"
			// "TZ"
			// "GEO"
			new ContactField("TITLE", Integer.valueOf(MAPIProp.PR_TITLE)),
			new ContactField("ROLE", Integer.valueOf(MAPIProp.PR_PROFESSION)),
			// "LOGO"
			// "AGENT"
			new ContactField("ORG",
					new Integer[] { Integer.valueOf(MAPIProp.PR_COMPANY_NAME),
							Integer.valueOf(MAPIProp.PR_DEPARTMENT_NAME) },
					ContactField.NONE, "%s;%s"),
			// "CATEGORIES"
			new ContactField("NOTE", Integer.valueOf(Attr.attBody), ContactField.ATTR, null),
			// "PRODID"
			// "REV"
			// "SORT-STRING
			// "SOUND"
			// "UID"
			new ContactField("URL;TYPE=WORK", Integer.valueOf(MAPIProp.PR_BUSINESS_HOME_PAGE)),
			// "CLASS"
			new ContactField("KEY;TYPE=X509", Integer.valueOf(MAPIProp.PR_USER_X509_CERTIFICATE),
	...
	static class ContactField {
		 ...
		 */
		public static final int NONE = 0, MUST = 1, ATTR = 2, BINARY = 4, CERT = 8;
		...
		public String getValue(net.freeutils.tnef.Message message) throws IOException {
			...
			if (src instanceof Integer) {
				...
				for (int i = 0; i < len; i++) {
					Integer id = ids[i];
					vals[i] = (id == null) ? null : escape((String) message.getMAPIProps().getPropValue(id.intValue()));
					if (vals[i] != null)
						hasValue = true;
				}
				if (hasValue)
		...
		String toString(Object val) throws IOException {
			...
			if (val != null) {
				if (val instanceof Date) {
					...
					df.setTimeZone(TimeZone.getTimeZone("GMT")); // mapi props
																	// should be
																	// GMT
					...
					if (isFlag(CERT)) {
						ris = getTLVProp(ris, 0x0003); // 0x003 is the actual
														// certificate
						// make sure it's a valid cert - it may just be the cert
						// hash
		...
		String fold(String v) {
			...
			if (vlen > 75) { // apply folding only if necessary
				...
				for (int i = 0; i < vlen; i++) {
					...
					if (count == 74) {
						if (breakpos == -1) // if there's no preferred break
											// position,
		...
		String format(String[] vals) {
			...
			for (int i = 0; i < len; i++) {
				...
				if (c == '%') { // process special format sequence
					...
					if (++i >= len)
						throw new IllegalArgumentException("format error at position " + i + ": " + format);
					// get format identifier char and output the appropriate
					// value
					c = format.charAt(i);
					if (c == 's') { // insert value string
						if (ind >= vals.length)
							throw new IllegalArgumentException("format error (too few parameters): " + format);
						if (vals[ind] != null)
							sb.append(vals[ind]);
						ind++;
		...
		RawInputStream getTLVProp(RawInputStream in, int tag) throws IOException {
			...
			while (in.available() >= 4) {
				int tg = in.readU16();
				int len = in.readU16() - 4; // subtract the tag and length
											// fields
				if (tg == tag)
