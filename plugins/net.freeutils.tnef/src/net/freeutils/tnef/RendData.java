...
/**
 * The <code>RendData</code> class encapsulates a TNEF attachment's rendering
 * data.
 *
...
public class RendData {
	 ...
	 */
	public static final int MAC_BINARY = 0x00000001, atypNull = 0, atypFile = 1, atypOle = 2, atypPicture = 3,
			atypMax = 4;
	 ...
	 *
	 * @param data
	 *            the TNEF stream to parse RendData from
	 * @throws IOException
	 ...
	 *
	 * @param type
	 *            the type of rendering data (from atyp* constants)
	 * @param position
	 *            the position to render data at
	 * @param width
	 *            the width of object to be rendered
	 * @param height
	 *            the height of object to be rendered
	 * @param flags
	 *            the flags describing the rendering data
	 */
	...
	public String toString() {
		...
		s.append("RendData:").append(" getType=").append(getType()).append(" getPosition=").append(getPosition())
				.append(" getWidth=").append(getWidth()).append(" getHeight=").append(getHeight()).append(" getFlags=")
				.append(getFlags());
		return s.toString();
	}
