...
public class VCardsContainer extends DavResource {
	...
	static {
		...
		props.add(MaxResourceSize.NAME);
		props.add(SyncToken.NAME);
		properties = ImmutableSet.copyOf(props);

		types = ImmutableList.of(Types.COL, Types.AB);
	}

	public VCardsContainer(String path) {
		super(path, ResType.VCARDS_CONTAINER);
	}
