...
public class ScheduleOutbox extends DavResource {
	...
	static {
		...
		types = ImmutableList.of(Types.COL, Types.SCHED_OUTBOX);
	}

	public ScheduleOutbox(String path) {
		super(path, ResType.SCHEDULE_OUTBOX);
	}
