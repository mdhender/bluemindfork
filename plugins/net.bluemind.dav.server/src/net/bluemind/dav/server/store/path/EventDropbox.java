...
public class EventDropbox extends DavResource {
	...
	static {
		...
		types = ImmutableList.of(Types.COL, Types.DROPBOX);
	}

	public EventDropbox(String path) {
		super(path, ResType.VEVENT_DROPBOX);
	}
