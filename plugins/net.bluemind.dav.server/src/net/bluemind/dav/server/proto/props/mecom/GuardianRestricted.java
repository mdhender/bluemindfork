...
public class GuardianRestricted implements IPropertyValue {

	private static final Logger logger = LoggerFactory.getLogger(GuardianRestricted.class);
	public static final QName NAME = new QName(NS.ME_COM, "guardian-restricted");

	public static IPropertyFactory factory() {
		return new IPropertyFactory() {
			@Override
			public IPropertyValue create() {
				return new GuardianRestricted();
			}
		};
	}
