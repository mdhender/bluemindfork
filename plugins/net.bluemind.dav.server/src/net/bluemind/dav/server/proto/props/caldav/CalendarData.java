...
public class CalendarData implements IPropertyValue {
	public static final QName NAME = new QName(NS.CALDAV, "calendar-data");
	private static final Logger logger = LoggerFactory.getLogger(CalendarData.class);
