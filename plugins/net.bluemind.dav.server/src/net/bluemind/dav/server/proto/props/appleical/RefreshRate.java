...
public class RefreshRate implements IPropertyValue {
	public static final QName NAME = new QName(NS.APPLE_ICAL, "refreshrate");
	private static final Logger logger = LoggerFactory.getLogger(RefreshRate.class);
