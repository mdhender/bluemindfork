...
public class MeCard implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "me-card");
	private static final Logger logger = LoggerFactory.getLogger(MeCard.class);
