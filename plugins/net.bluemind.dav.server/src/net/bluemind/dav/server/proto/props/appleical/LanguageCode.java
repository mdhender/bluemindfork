...
public class LanguageCode implements IPropertyValue {
	public static final QName NAME = new QName(NS.APPLE_ICAL, "language-code");
	private static final Logger logger = LoggerFactory.getLogger(LanguageCode.class);
