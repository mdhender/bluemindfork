...
public class SubscribedStripTodos implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "subscribed-strip-todos");
	private static final Logger logger = LoggerFactory.getLogger(SubscribedStripTodos.class);
	...
	public static IPropertyFactory factory() {
		return new IPropertyFactory() {
			...
			public IPropertyValue create() {
				return new SubscribedStripTodos();
			}
		};
	}
