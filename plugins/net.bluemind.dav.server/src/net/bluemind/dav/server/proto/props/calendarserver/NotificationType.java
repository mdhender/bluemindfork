...
public class NotificationType implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "notificationtype");
	private static final Logger logger = LoggerFactory.getLogger(NotificationType.class);
