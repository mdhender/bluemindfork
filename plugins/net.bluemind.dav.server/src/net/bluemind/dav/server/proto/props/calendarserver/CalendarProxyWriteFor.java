...
public class CalendarProxyWriteFor extends CalendarProxyXXFor {
	public static final QName NAME = new QName(NS.CSRV_ORG, "calendar-proxy-write-for");

	private static final Logger logger = LoggerFactory.getLogger(CalendarProxyWriteFor.class);
