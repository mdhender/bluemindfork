...
public class CalendarDescription implements IPropertyValue {
	public static final QName NAME = new QName(NS.CALDAV, "calendar-description");
	private static final Logger logger = LoggerFactory.getLogger(CalendarDescription.class);
