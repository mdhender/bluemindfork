...
public class CalendarMultigetResponse extends ReportResponse {

	private List<ItemValue<VEventSeries>> events;
	private List<ItemValue<VTodo>> todos;
	private List<QName> props;

	public CalendarMultigetResponse(String href, QName kind, List<ItemValue<VEventSeries>> events, List<QName> props) {
		super(href, kind);
		this.events = events;
		this.props = props;
	}

	public CalendarMultigetResponse(String href, QName kind, List<ItemValue<VTodo>> events, List<QName> props,
			Object useless) {
		super(href, kind);
		this.todos = events;
		this.props = props;
