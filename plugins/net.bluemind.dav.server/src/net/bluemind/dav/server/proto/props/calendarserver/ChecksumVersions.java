...
public class ChecksumVersions implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "checksum-versions");
	private static final Logger logger = LoggerFactory.getLogger(ChecksumVersions.class);
