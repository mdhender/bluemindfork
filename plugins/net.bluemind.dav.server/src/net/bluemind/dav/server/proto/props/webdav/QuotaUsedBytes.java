...
public class QuotaUsedBytes implements IPropertyValue {

	private static final Logger logger = LoggerFactory.getLogger(QuotaUsedBytes.class);

	public static final QName NAME = new QName(NS.WEBDAV, "quota-used-bytes");
	...
	public void fetch(LoggedCore lc, DavResource dr) {
		logger.debug("No cal quota usage in BM");
	}
