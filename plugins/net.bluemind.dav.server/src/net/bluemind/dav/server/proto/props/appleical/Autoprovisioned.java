...
public class Autoprovisioned implements IPropertyValue {
	public static final QName NAME = new QName(NS.APPLE_ICAL, "autoprovisioned");
	private static final Logger logger = LoggerFactory.getLogger(Autoprovisioned.class);
