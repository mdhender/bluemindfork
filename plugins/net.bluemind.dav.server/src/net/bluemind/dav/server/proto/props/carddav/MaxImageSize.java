...
public class MaxImageSize implements IPropertyValue {

	private static final Logger logger = LoggerFactory.getLogger(MaxImageSize.class);

	public static final QName NAME = new QName(NS.CARDDAV, "max-image-size");
	...
	public void fetch(LoggedCore lc, DavResource dr) {
		logger.warn("max image size does not exist in BM");
	}
