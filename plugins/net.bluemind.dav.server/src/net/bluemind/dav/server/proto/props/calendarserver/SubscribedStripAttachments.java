...
public class SubscribedStripAttachments implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "subscribed-strip-attachments");
	private static final Logger logger = LoggerFactory.getLogger(SubscribedStripAttachments.class);
	...
	public static IPropertyFactory factory() {
		return new IPropertyFactory() {
			...
			public IPropertyValue create() {
				return new SubscribedStripAttachments();
			}
		};
	}
