...
public class ScheduleDefaultCalendarUrl extends HrefSet {

	public static final QName NAME = new QName(NS.CALDAV, "schedule-default-calendar-URL");

	public ScheduleDefaultCalendarUrl() {
		super(NAME);
	}
