...
public class MaxAttendeesPerInstance implements IPropertyValue {

	private static final Logger logger = LoggerFactory.getLogger(MaxAttendeesPerInstance.class);
	public static final QName NAME = new QName(NS.CALDAV, "max-attendees-per-instance");
