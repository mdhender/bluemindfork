...
public class CurrentUserPrincipal extends HrefSet {

	@SuppressWarnings("unused")
	private static final Logger logger = LoggerFactory.getLogger(CurrentUserPrincipal.class);

	public static final QName NAME = new QName(NS.WEBDAV, "current-user-principal");
	...
	public void fetch(LoggedCore lc, DavResource dr) throws Exception {
		String href = Proxy.path + "/principals/__uids__/" + lc.getUser().uid + "/";
