...
public class SubscribedStripAlarms implements IPropertyValue {
	public static final QName NAME = new QName(NS.CSRV_ORG, "subscribed-strip-alarms");
	private static final Logger logger = LoggerFactory.getLogger(SubscribedStripAlarms.class);
	...
	public static IPropertyFactory factory() {
		return new IPropertyFactory() {
			...
			public IPropertyValue create() {
				return new SubscribedStripAlarms();
			}
		};
	}
