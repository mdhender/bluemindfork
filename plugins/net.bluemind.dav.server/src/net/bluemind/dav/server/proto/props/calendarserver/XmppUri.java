...
public class XmppUri implements IPropertyValue {
	public static final QName NAME = QN.qn(NS.CSRV_ORG, "xmpp-uri");
	private static final Logger logger = LoggerFactory.getLogger(XmppUri.class);
