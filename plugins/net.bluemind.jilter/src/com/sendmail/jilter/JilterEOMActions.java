...
/**
 * Contains the actions available during {@link JilterHandler#eom eom}
 * processing.
 */
...
public interface JilterEOMActions {
	 ...
	 *            the header name.
	 * @param hdridx
	 *            header index value (1-based). A hdridx value of 1 will modify
	 *            the first occurrence of a header named headerf. If hdridx is
	 *            greater than the number of times headerf appears, a new copy
	 *            of headerf will be added.
	 * @param headerv
	 *            the new value of the given header. headerv ==
	 *            <code>null</code> indicates that the header should be deleted.
	 */
	 ...
	 * 
	 * @param rcpt
	 *            the recipient address to be removed.
	 */
	 ...
	 * 
	 * @param bodyp
	 *            a buffer containing the new body data. Body data should be in
	 *            CR/LF form.
	 */
	...
	/**
	 * Set the resulting EOM status. Note: Calling the method essentially
	 * invalidates this object. The result of any subsequent calls to methods on
	 * this object is undefined.
	 * 
	 * @param status
	 *            the resulting status of EOM processing.
	 */
