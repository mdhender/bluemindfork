...
public class IOSReplyTest extends IMIPTestCase {

	public void testReplyAccept() throws Exception {
		Message m = parseData("ios.reply.accept.eml");
		assertNotNull(m);
	...
	public void testReplyTentative() throws Exception {
		Message m = parseData("ios.reply.tentative.eml");
		assertNotNull(m);
	...
	public void testReplyDecline() throws Exception {
		Message m = parseData("ios.reply.decline.eml");
		assertNotNull(m);
