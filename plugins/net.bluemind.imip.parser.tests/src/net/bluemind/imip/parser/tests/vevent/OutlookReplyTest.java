...
public class OutlookReplyTest extends IMIPTestCase {

	public void testReplyAccept() throws Exception {
		Message m = parseData("outlook.reply.accept.eml");
		assertNotNull(m);
	...
	public void testReplyTentative() throws Exception {
		Message m = parseData("outlook.reply.tentative.eml");
		assertNotNull(m);
	...
	public void testReplyDecline() throws Exception {
		Message m = parseData("outlook.reply.decline.eml");
		assertNotNull(m);
