...
public class LmtpAddress {
	...
	private DeliveredVersion deliveredVersion;
	...
	public LmtpAddress(String arg, String[] allowedParameters, String rcptDelim) {
		...
		int delimIndex = -1;
		if (localPart != null && rcptDelim != null && (delimIndex = localPart.indexOf(rcptDelim)) > 0) {
	...
	public DeliveredVersion getDeliveredVersion() {
		return deliveredVersion;
	}

	public void setDeliveredVersion(DeliveredVersion deliveredVersion) {
