...
Requires:           bm-node = %{version}-%{release}, bm-tick-node = %{version}-%{release}, bm-chronograf = 1.7.12.bm1~81b47b2c2, bm-kapacitor = 1.5.3.bm2~8ce0726f, bm-influxdb = 1.7.7.bm2~6d19fef88
