...
Requires:           bm-node = %{version}-%{release}, bm-conf = %{version}-%{release}, bm-postfix = %{version}-%{release}, bm-nginx = 1.18.0-bluemind95, bm-ysnp = %{version}-%{release}, bm-tick-node = %{version}-%{release}
