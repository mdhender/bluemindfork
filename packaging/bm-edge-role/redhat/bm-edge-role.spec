...
Requires:           bm-node = %{version}-%{release}, bm-conf = %{version}-%{release}, bm-postfix = %{version}-%{release}, bm-nginx = 1.16.1-bluemind92, bm-ysnp = %{version}-%{release}, bm-tick-node = %{version}-%{release}
