...
Requires:           bm-node = %{version}-%{release}, bm-conf = %{version}-%{release}, bm-postfix = %{version}-%{release}, bm-nginx = 1.14.0-bluemind79, bm-ysnp = %{version}-%{release}, bm-tick-node = %{version}-%{release}
