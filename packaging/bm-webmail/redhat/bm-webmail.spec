...
Requires:           bm-postgresql = 15.3-bluemind227, bm-nginx = 1.24.0-bluemind106, bm-php = 5.6.40-bluemind107, tzdata, epel-release >= 6, memcached, bm-plugin-core-webmail = %{version}-%{release}
Conflicts:          bm-apache
Obsoletes:          bm-apache
