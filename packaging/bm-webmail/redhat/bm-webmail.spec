...
Requires:           bm-postgresql = 15.4-bluemind243, bm-nginx = 1.24.0-bluemind109, bm-php = 5.6.40-bluemind115, tzdata, epel-release >= 6, memcached, bm-plugin-core-webmail = %{version}-%{release}
Conflicts:          bm-apache
Obsoletes:          bm-apache
