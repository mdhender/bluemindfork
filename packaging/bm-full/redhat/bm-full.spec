...
Requires:           bm-core = %{version}-%{release}, bm-postgresql = 11.7-bluemind108, bm-locator = %{version}-%{release}, bm-admin-console = %{version}-%{release}, bm-eas = %{version}-%{release}, bm-conf = %{version}-%{release}, bm-postfix = %{version}-%{release}, bm-cyrus = %{version}-%{release}, bm-webserver = %{version}-%{release}, bm-wizard = %{version}-%{release}, bm-lmtpd = %{version}-%{release}, bm-calendar = %{version}-%{release}, bm-node = %{version}-%{release}, bm-contact = %{version}-%{release}, bm-settings = %{version}-%{release}, bm-im = %{version}-%{release}, bm-xmpp = %{version}-%{release}, bm-hps = %{version}-%{release}, bm-default-app = %{version}-%{release}, bm-client-access = %{version}-%{release}, bm-webmail = %{version}-%{release}, bm-elasticsearch = 1:6.8.6-bluemind83, bm-autodiscover = %{version}-%{release}, bm-push = %{version}-%{release}, bm-todolist = %{version}-%{release}, bm-chooser = %{version}-%{release}, bm-plugin-core-cti = %{version}-%{release}, bm-plugin-webserver-cti = %{version}-%{release}, bm-plugin-webserver-dav = %{version}-%{release}, bm-tick-full = %{version}-%{release}, bm-tick-node = %{version}-%{release}, bm-plugin-core-monitoring = %{version}-%{release}
