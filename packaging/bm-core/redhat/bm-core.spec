...
Conflicts:          bm-soap, bm-plugin-core-dataprotect-upgrade, bm-plugin-core-hoster-report, bm-plugin-core-mapi-support, bm-plugin-core-monitoring, bm-locator, bm-plugin-core-videoconferencing-starleaf, bm-xmpp, bm-im
Obsoletes:          bm-soap, bm-plugin-core-dataprotect-upgrade, bm-plugin-core-hoster-report, bm-plugin-core-mapi-support, bm-plugin-core-monitoring, bm-locator, bm-plugin-core-videoconferencing-starleaf, bm-xmpp, bm-im
