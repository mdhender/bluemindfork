...
Conflicts:          bm-soap, bm-plugin-core-dataprotect-upgrade, bm-plugin-hoster-report
Obsoletes:          bm-soap, bm-plugin-core-dataprotect-upgrade, bm-plugin-hoster-report
