...
Requires:           bm-jdk = 17.0.4.1+1-bluemind12, bm-conf = %{version}-%{release}, openssl, ca-certificates, bm-tika = %{version}-%{release}, bm-plugin-core-subscription = %{version}-%{release}, bm-upgraders-list = %{version}-%{release}
...
%post -p /bin/bash
rm -rf /usr/share/bm-core/extensions/eclipse/plugins
mkdir -p /usr/share/bm-core/extensions/eclipse/plugins
