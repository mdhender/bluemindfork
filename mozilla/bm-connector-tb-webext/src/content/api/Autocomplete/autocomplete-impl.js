    ...
    return {
      AutocompleteApi: {
        init: async function () {
          ...
          var { BMFolderHome } = ChromeUtils.import("chrome://bm/content/modules/core2/BMFolderHome.jsm");
              ...
              autoCompleteSearch: function(aSearchListener) {
                  ...
                  if (bmUtils.getSettings(user, pwd, srv, true)) {
                      ...
                      result.then(function(logged) {
                          ...
                          return client.search({"kindsFilter": ["USER", "GROUP"], "nameOrEmailFilter": self._fullString, "size": 10});
