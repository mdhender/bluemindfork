...
var BmDirectoryApi = class extends ExtensionCommon.ExtensionAPI {
    getAPI(context) {
        return {
            BmDirectoryApi: {
                init: async function () {
                    ...
                    let classID = Components.ID("{ad4e8d8c-e5a3-4a72-bfc3-35ddb905cebe}");
                    let contractID = "@mozilla.org/addressbook/directory;1?type=bmdirectory";
                    ...
                    let factory = XPCOMUtils.generateNSGetFactory([BmDirectory])(classID);
                    ...
                    Components.manager.registerFactory(classID, "BmDirectory", contractID,
                        factory);
                    context.callOnClose({
                        close() {
