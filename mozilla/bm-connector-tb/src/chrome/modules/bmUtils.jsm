...
Components.utils.import("resource://bm/bmPhotos.jsm");
...
let bmUtils = {
    ...
    _stringBundle: Components.classes["@mozilla.org/intl/stringbundle;1"]
        ...
        .createBundle("chrome://bm/locale/bm.properties"),
    ...
    _getBmImapAccount: function(aBmSrv) {
		...
		for (let i = 0; i < accounts.length; i++) {
			let acc = accounts.queryElementAt(i, Components.interfaces.nsIMsgAccount);
    ...
    getLocalizedString: function(aStringName) {
        return this._stringBundle.GetStringFromName("extensions.bm." + aStringName);
    },
    ...
    deleteAllBmDirectories: function() {
        ...
        let historyUri = "moz-abmdbdirectory://history.mab";
        while (it.hasMoreElements()) {
            ...
            if (directory instanceof Components.interfaces.nsIAbDirectory) {
                ...
                if (id != null) {
                    if (directory.URI == historyUri) {
                        this.deletePrefBranch(historyUri);
                        //delete bm cards
                        ...
                        while (cards.hasMoreElements()) {
                            ...
                            if (id) {
                                cardsToDel.appendElement(card, false);
                            }
                        }
    ...
    isBmList: function(directory) {
        ...
        let uri = directory.URI;
        let parentUri = uri.substring(0, uri.indexOf("mab") + 3);
    ...
    isBmReadOnlyList: function(directory) {
        ...
        // "moz-abmdbdirectory://abook-5.mab/MailList1"
        let parentUri = uri.substring(0, uri.indexOf("mab") + 3);
        let parentDir = MailServices.ab.getDirectory(parentUri);
