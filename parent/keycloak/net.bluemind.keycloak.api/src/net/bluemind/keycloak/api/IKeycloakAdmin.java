...
public interface IKeycloakAdmin {
	...
	@PUT
	@Path("{domainId}/{clientId}")
	public void createClient(@PathParam(value = "domainId") String domainId,
			@PathParam(value = "clientId") String clientId) throws ServerFault;

	@GET
	@Path("{domainId}/{clientId}")
	public String getClientSecret(@PathParam(value = "domainId") String domainId,
			@PathParam(value = "clientId") String clientId) throws ServerFault;
