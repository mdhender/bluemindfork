...
public class OidcClient {
	...
	public JsonObject toJson() {
		return new JsonObject()
				...
				.put("publicClient", publicClient)
				.put("secret", secret)
				.put("standardFlowEnabled", standardFlowEnabled)
				.put("directAccessGrantsEnabled", directAccessGrantsEnabled)
				.put("serviceAccountsEnabled", serviceAccountsEnabled)
				.put("rootUrl", rootUrl)
				.put("redirectUris", redirectUris)
				.put("webOrigins", webOrigins);
	}
}
