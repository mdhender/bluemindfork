...
public class SendMailEndpoint extends WbxmlHandlerBase implements IEasRequestEndpoint {
	...
	private static final Logger logger = LoggerFactory.getLogger(SendMailEndpoint.class);
	private SendMailProtocol protocol;

	public SendMailEndpoint() {
		protocol = new SendMailProtocol();
	}

	@Override
	public void handle(AuthorizedDeviceQuery dq, Document doc, String userLogin) {
		if (logger.isDebugEnabled()) {
			EasLogUser.logDebugAsUser(userLogin, logger, "SendMail with protocol...");
		}
