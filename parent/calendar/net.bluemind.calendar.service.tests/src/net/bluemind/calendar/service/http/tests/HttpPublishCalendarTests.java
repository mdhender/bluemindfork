...
import net.bluemind.calendar.service.tests.PublishCalendarTests;
import net.bluemind.core.api.fault.ServerFault;
import net.bluemind.core.container.model.Container;
import net.bluemind.core.context.SecurityContext;
import net.bluemind.core.rest.http.ClientSideServiceProvider;

public class HttpPublishCalendarTests extends PublishCalendarTests {
	...
	protected IPublishCalendar getPublishCalendarService(SecurityContext context, Container container)
		...
		return ClientSideServiceProvider.getProvider("http://127.0.0.1:8090", context.getSessionId())
				.instance(IPublishCalendar.class, container.uid);
	}
}
