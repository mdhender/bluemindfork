...
import net.bluemind.calendar.service.tests.CalendarAutocompleteServiceTests;
import net.bluemind.core.api.fault.ServerFault;
import net.bluemind.core.context.SecurityContext;
import net.bluemind.core.rest.http.ClientSideServiceProvider;

public class HttpCalendarAutocompleteServiceTests extends CalendarAutocompleteServiceTests {
	...
	public ICalendarAutocomplete getService(SecurityContext context) throws ServerFault {
		return ClientSideServiceProvider.getProvider("http://127.0.0.1:8090", context.getSessionId())
				.instance(ICalendarAutocomplete.class);
	}
}
