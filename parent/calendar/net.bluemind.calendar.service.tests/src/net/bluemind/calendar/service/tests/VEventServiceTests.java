...
public class VEventServiceTests extends AbstractCalendarTests {
	...
	public void testExportOne() throws ServerFault {
		...
		assertTrue(export.contains(
				"RRULE:FREQ=WEEKLY;UNTIL=20221225T133000;INTERVAL=2;BYWEEKNO=8,13,42;BYYEARDAY=8,13,42,200;BYMONTHDAY=8;BYDAY=MO,TU,TH,FR,SU;BYHOUR=2,22;BYMINUTE=1,2,3;BYSECOND=10,20;BYSETPOS=4,7"));
	...
	public void testImportRRuleBySetPos() throws ServerFault, IOException {
		...
		assertEquals(2, vevent.rrule.bySetPos.size());
		assertTrue(vevent.rrule.bySetPos.contains(2));
		assertTrue(vevent.rrule.bySetPos.contains(3));
	}
