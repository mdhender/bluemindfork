...
public class CalendarServiceFactory implements ServerSideServiceProvider.IServerSideServiceFactory<ICalendar> {

	private ICalendar getService(BmContext context, String containerId) throws ServerFault {
