...
public class UserAccountSimple extends UserAccountProvider {
	...
	public Set<String> sanitizeRoles(BmContext bmContext, Set<String> roles, String domainName, ItemValue<User> user,
		...
		return bmContext.su().provider().instance(IInternalRoles.class).resolve(DefaultRoles.SIMPLE_USER_DEFAULT_ROLES);
	}
