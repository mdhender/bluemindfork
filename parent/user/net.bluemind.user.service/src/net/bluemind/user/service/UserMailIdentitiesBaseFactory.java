...
public abstract class UserMailIdentitiesBaseFactory<T extends IUserMailIdentities>
	...
	protected abstract T create(BmContext context, ItemValue<Domain> domainValue, Container container, String userUid,
			List<IUserMailIdentityHook> identityHooks);
	...
	private T getService(BmContext context, String domainUid, String userUid) {
		...
		return create(context, domainValue, container, userUid, identityHooks);
	}
