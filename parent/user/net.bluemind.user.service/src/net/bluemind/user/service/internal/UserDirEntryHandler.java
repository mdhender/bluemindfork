...
public class UserDirEntryHandler extends DirEntryHandler {
	...
	@Override
	public Kind kind() {
		return DirEntry.Kind.USER;
	}

	@Override
	public byte[] getIcon(BmContext context, String domainUid, String uid) throws ServerFault {
		byte[] icon = context.getServiceProvider().instance(IUser.class, domainUid).getIcon(uid);
	...
	public TaskRef entryDeleted(BmContext context, String domainUid, String entryUid) throws ServerFault {
		return context.getServiceProvider().instance(IInCoreUser.class, domainUid).delete(entryUid);
	}
