...
public class ForRecipient2MailTipHandlerTip1 implements IMailTipEvaluation {
	...
	public List<EvaluationResult> evaluate(String domainUid, MessageContext messageContext) {
		return Arrays.asList(EvaluationResult.matchesForRecipient(messageContext.recipients.get(1),
				"ForRecipient2MailTipHandlerTip1"));
	}
