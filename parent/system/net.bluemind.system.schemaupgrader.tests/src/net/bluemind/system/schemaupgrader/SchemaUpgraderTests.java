...
public class SchemaUpgraderTests {
	...
	public void testComputeUpgradePath() throws ServerFault {
		List<DatedUpdater> path = SchemaUpgrade.getUpgradePath();
	...
	private boolean upgradersFound(List<String[]> expected, List<DatedUpdater> path) {
