...
public class WebmailPhpNginxConf extends AbstractConfFile {
	private long messageSizeLimit;
	private static String path = Path.WEBMAIL_PATH + "/" + Path.WEBMAIL_NGINX_CF;

	public WebmailPhpNginxConf(INodeClient nc) throws ServerFault {
		super(nc);
	}

	@Override
	public void write() throws ServerFault {
		Template mcf = openTemplate(getClass(), "webmailNginxFpm.conf");
