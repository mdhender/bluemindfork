...
public class GroupGetCommand implements ICmdLet, Runnable  {
	...
	@Arguments(required = true, description = "GroupName@domain or domain name")
	public String target;

	@Option(name = "--show-members", description = "Show members and group properties")
	boolean showMembers;

	@Option(name = "--resolved-members", description = "show members by email")
	public boolean resolvedMembers;
	
	@Option(name = "--expand-members", description = "show members and members of sub-groups.")
