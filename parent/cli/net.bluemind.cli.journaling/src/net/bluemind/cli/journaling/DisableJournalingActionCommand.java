...
@Command(name = "disable", description = "Disable a journaling mailflow action rule")
public class DisableJournalingActionCommand implements ICmdLet, Runnable {
	...
	public void run() {
		...
		ctx.info("Journaling action '{}' disabled", assignment.uid);
	}
	...
	public static class Reg implements ICmdLetRegistration {
		...
		public Class<? extends ICmdLet> commandClass() {
			return DisableJournalingActionCommand.class;
		}
	}
