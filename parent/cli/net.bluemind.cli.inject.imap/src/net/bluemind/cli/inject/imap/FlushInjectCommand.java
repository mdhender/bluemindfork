...
@Command(name = "flush", description = "Injects a batch of emails through IOutbox::flush")
public class FlushInjectCommand extends AbstractMailInjectCommand {
