...
public class ScheduledJobServiceFactory implements ServerSideServiceProvider.IServerSideServiceFactory<IJob> {
	...
	@Override
	public IJob instance(BmContext context, String... params) throws ServerFault {
