...
public class MemberUidLdapScannerTests extends ScannerCommon {
	...
	protected void scanLdap(ImportLogger importLogger, CoreServicesTest coreService, LdapParameters ldapParameters) {
		MemberUidLdapScanner ldapScanner = new MemberUidLdapScanner(importLogger, coreService, ldapParameters, domain);
		ldapScanner.scan();
	}
	...
	protected void scanLdap(ImportLogger importLogger, CoreServicesTest coreService, LdapParameters ldapParameters,
		...
		MemberUidLdapScanner ldapScanner = new MemberUidLdapScanner(importLogger, coreService,
