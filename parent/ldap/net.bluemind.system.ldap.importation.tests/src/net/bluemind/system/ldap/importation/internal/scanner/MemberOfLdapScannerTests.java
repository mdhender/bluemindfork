 ...
 *
 */
public class MemberOfLdapScannerTests extends ScannerMemberMemberOf {
	...
	protected void scanLdap(ImportLogger importLogger, CoreServicesTest coreService, LdapParameters ldapParameters) {
		MemberOfLdapScanner ldapScanner = new MemberOfLdapScanner(importLogger, coreService, ldapParameters, domain);
		ldapScanner.scan();
	}
	...
	protected void scanLdap(ImportLogger importLogger, CoreServicesTest coreService, LdapParameters ldapParameters,
		...
		MemberOfLdapScanner ldapScanner = new MemberOfLdapScanner(importLogger, coreService,
