...
public abstract class AbstractRepairTests {
	...
	protected IServiceProvider getProvider(SecurityContext context) throws ServerFault {
		return ServerSideServiceProvider.getProvider(context);
	}

	protected Mailshare defaultMailshare(String name) {
		Mailshare mailbox = new Mailshare();
