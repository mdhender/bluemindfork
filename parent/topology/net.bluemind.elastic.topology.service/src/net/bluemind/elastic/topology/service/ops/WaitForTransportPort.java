...
public class WaitForTransportPort implements IServerTask {

	private ItemValue<Server> node;

	public WaitForTransportPort(ItemValue<Server> node) {
		this.node = node;
	}
	...
	public CompletableFuture<Void> execute(IServerTaskMonitor monitor) {
		...
		nh.waitForListeningPort(9300, 10, TimeUnit.SECONDS);
