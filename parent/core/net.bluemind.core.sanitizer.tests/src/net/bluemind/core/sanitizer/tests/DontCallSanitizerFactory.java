...
public class DontCallSanitizerFactory implements ISanitizerFactory<DontCall> {
	 ...
	 */
	@Override
	public ISanitizer<DontCall> create(BmContext context, Container container) {
		return new DontCallSanitizer(context);
	}
