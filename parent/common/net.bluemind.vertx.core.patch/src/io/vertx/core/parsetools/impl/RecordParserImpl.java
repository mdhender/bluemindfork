...
public class RecordParserImpl implements RecordParser {
	...
	/**
	 * Create a new {@code RecordParser} instance, initially in delimited mode, and
	 * where the delimiter can be represented by the String {@code} delim endcoded
	 * in latin-1 . Don't use this if your String contains other than latin-1
	 * characters.
	 * <p>
	...
	/**
	 * Create a new {@code RecordParser} instance, initially in delimited mode, and
	 * where the delimiter can be represented by the {@code buffer} delim.
	 * <p>
	 * {@code output} Will receive whole records which have been parsed.
	 *
	...
	/**
	 * Create a new {@code RecordParser} instance, initially in fixed size mode, and
	 * where the record size is specified by the {@code size} parameter.
	 * <p>
	 * {@code output} Will receive whole records which have been parsed.
	 *
	 ...
	 * <p>
	 * This method can be called multiple times with different values of delim while
	 ...
	 * {@code size} in bytes.
	 * <p>
	 * This method can be called multiple times with different values of size while
	 * data is being parsed.
	 *
	...
	/**
	 * Set the maximum allowed size for a record when using the delimited mode. The
	 * delimiter itself does not count for the record size.
	 * <p>
	 * If a record is longer than specified, an {@link IllegalStateException} will
	 * be thrown.
	 *
