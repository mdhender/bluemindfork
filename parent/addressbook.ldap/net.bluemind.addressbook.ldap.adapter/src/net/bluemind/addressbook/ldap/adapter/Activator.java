...
public class Activator implements BundleActivator {
	...
	private static List<ILdapContactEnhancer> loadLdapContactEnhancerHooks() {
		RunnableExtensionLoader<ILdapContactEnhancer> loader = new RunnableExtensionLoader<ILdapContactEnhancer>();
		return loader.loadExtensionsWithPriority("net.bluemind.addressbook.ldap.adapter", "ldapcontactenhancer", "hook",
				"impl");
	}
