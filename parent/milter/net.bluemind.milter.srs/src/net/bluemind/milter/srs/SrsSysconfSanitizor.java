...
public class SrsSysconfSanitizor implements ISystemConfigurationSanitizor {
	...
	public void sanitize(SystemConf previous, Map<String, String> modifications) throws ServerFault {
		if (!modifications.containsKey(SysConfKeys.srs_disabled.name())) {
			return;
		}

		modifications.put(SysConfKeys.srs_disabled.name(),
				Boolean.valueOf(modifications.get(SysConfKeys.srs_disabled.name())).toString());
	}
}
