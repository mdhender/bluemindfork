...
public class MailRuleEvaluation {
	...
	private MailRuleEvaluation(boolean matches, Map<String, String> data) {
	...
	public static MailRuleEvaluation accepted(Map<String, String> data) {
		return new MailRuleEvaluation(true, Collections.unmodifiableMap(data));
	}
