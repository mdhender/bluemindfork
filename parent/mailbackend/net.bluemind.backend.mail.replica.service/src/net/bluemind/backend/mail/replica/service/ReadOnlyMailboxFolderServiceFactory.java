...
public class ReadOnlyMailboxFolderServiceFactory<T>
		extends AbstractByContainerReplicatedMailboxesServiceFactory<IReadOnlyMailboxFolders> {

	protected IReadOnlyMailboxFolders create(MailboxReplicaRootDescriptor mailboxRoot, Container foldersContainer,
	...
	@Override
	public Class<IReadOnlyMailboxFolders> factoryClass() {
		return IReadOnlyMailboxFolders.class;
	}
