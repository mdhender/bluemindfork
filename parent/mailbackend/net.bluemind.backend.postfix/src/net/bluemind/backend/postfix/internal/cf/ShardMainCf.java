...
public class ShardMainCf extends AbstractConfFile {

	private String hostname;
	private String relayHost;

	public ShardMainCf(IServer service, String serverUid) throws ServerFault {
	...
	public void write() throws ServerFault {
		...
		Template cyrusConf = openTemplate("shard-main.cf");
