 ...
 * END LICENSE
 */
package net.bluemind.addressbook.job;
...
public class ContactIndexJob implements IScheduledJob {

	private static final Logger logger = LoggerFactory.getLogger(ContactIndexJob.class);
	...
	private void run(IScheduler sched, IScheduledJobRunId rid) throws Exception {
		...
		IInCoreAddressBooksMgmt abMgmt = context.provider().instance(IInCoreAddressBooksMgmt.class);

		abMgmt.reindexAll(new SchedulerProgressMonitor(sched, rid));
	}
	...
	public String getDescription(String locale) {
		if ("fr".equals(locale)) {
			return "Indexation des contacts";
		}
		return "Contacts indexing";
	}
