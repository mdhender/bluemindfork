...
public class PublicCertMailTipEvaluation implements IMailTipEvaluation {
	...
	public List<EvaluationResult> evaluate(String domainUid, MessageContext messageContext) {
		var senderUid = ServerSideServiceProvider.getProvider(SecurityContext.SYSTEM)
				.instance(IDirectory.class, domainUid).getByEmail(messageContext.fromIdentity.sender).entryUid;
