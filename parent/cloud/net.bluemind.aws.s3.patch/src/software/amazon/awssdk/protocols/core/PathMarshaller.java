...
public abstract class PathMarshaller {
	...
	/**
	 * Marshaller for non greedy path labels. Value is URL encoded and then replaced
	 * in the request URI.
	 */
	public static final PathMarshaller NON_GREEDY = new NonGreedyPathMarshaller();

	/**
	 * Marshaller for greedy path labels. Value is not URL encoded and replaced in
	 * the request URI.
	 */
	public static final PathMarshaller GREEDY = new GreedyPathMarshaller();

	/**
	 * Marshaller for greedy path labels that allows leading slahes. Value is not
	 * URL encoded and replaced in the request URI.
	 */
