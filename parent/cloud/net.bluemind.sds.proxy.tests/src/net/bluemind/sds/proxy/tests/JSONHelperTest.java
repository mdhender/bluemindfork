...
public class JSONHelperTest {
	...
	public void validJSON() {
		...
		JsonObject json = new JsonObject().put("prop1", "val").put("prop2", "value");
	...
	public void missingProp() {
		String[] fieldNames = new String[] { "prop1", "prop2" };
		JsonObject json = new JsonObject().put("prop1", "val");
	...
	public void unnecessaryProp() {
		String[] fieldNames = new String[] { "prop1", "prop2" };
		JsonObject json = new JsonObject().put("prop1", "val").put("prop2", "val").put("prop3", "val");
		assertTrue(JsonHelper.isValidJson(json, fieldNames));
	}
	...
	public void validJsonString() {
		assertEquals(new JsonObject().put("prop1", "value"), JsonHelper.getJsonFromString("{\"prop1\": \"value\"}"));
	}
