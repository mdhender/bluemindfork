...
public final class Sudo implements AutoCloseable {
	...
	public Sudo(String login, String domainContainerUid) throws ServerFault {
		...
		if (theUser == null) {
			throw ServerFault.notFound("UID for " + login + " in " + domainContainerUid + " not found.");
		}
		logger.debug("[{}] sudo login {} has uid {}", domainContainerUid, login, theUser.uid);
