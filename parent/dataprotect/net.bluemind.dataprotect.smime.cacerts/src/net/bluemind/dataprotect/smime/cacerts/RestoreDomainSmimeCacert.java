/* BEGIN LICENSE
  ...
  * END LICENSE
  */
package net.bluemind.dataprotect.smime.cacerts;
...
public class RestoreDomainSmimeCacert implements IRestoreActionProvider {

	public static String identifier = "replace.smimecacerts";

	public RestoreDomainSmimeCacert() {
	}
	...
	public TaskRef run(RestoreOperation op, DataProtectGeneration backup, Restorable item) throws ServerFault {
		...
		return tsk.run(new RestoreSmimeCacertTask(backup, item));
	}
	...
	public List<RestoreOperation> operations() {
		...
		replace.kind = RestorableKind.DOMAIN;
