...
public class VTodoServiceFactory implements IServerSideServiceFactory<IVTodo> {
	...
	@Override
	public IVTodo instance(BmContext context, String... params) throws ServerFault {
		...
		return new VTodoService(context, context.getServiceProvider().instance(ITodoList.class, containerUid));
	}
